...
namespace Abar.Controllers
{
    public class PessoasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Nome,Sobrenome,Email,Senha,Identidade_de_Genero,Orientacao_Sexual")] Pessoa Home)
        {
            if (ModelState.IsValid)
            {
                _context.Add(Home);
                await _context.SaveChangesAsync();
                return RedirectToAction(nameof(Feed_));
            }
            return View(Home);
        }
